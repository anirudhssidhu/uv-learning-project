...
if os.environ.get("UV_DEMO_COMPILE_MYPYC") == "1":
...
def get_ext_modules():
    ...
    If the `UV_DEMO_COMPILE_MYPYC` environment variable is set to "1",
    ...
    if os.environ.get("UV_DEMO_COMPILE_MYPYC") == "1":
        ...
        # For example:
        # return mypycify([
        #     "src/uv_demo/__main__.py",
        #     "src/uv_demo/some_other_module.py",
        # ])
        return mypycify(
            [
                "src/uv_demo/__main__.py",
